const markdownCore = window.CraneMarkdownCore;
...
function markdownTable(lines) {
  return markdownCore.markdownTable(lines);
}

function isTableDividerCell(value) {
  return markdownCore.isTableDividerCell(value);
}

function splitTableRow(value) {
  return markdownCore.splitTableRow(value);
}

function trimOuterTablePipes(value) {
  return markdownCore.trimOuterTablePipes(value);
}

function isEscaped(value, index) {
  return markdownCore.isEscaped(value, index);
}
...
function normalizeCodeLanguage(value) {
  return markdownCore.normalizeCodeLanguage(value);
}

function codeInfoString(value) {
  return markdownCore.codeInfoString(value);
}

function highlightCode(code, language) {
  return markdownCore.highlightCode(code, language);
}
